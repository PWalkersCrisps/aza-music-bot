...
module.exports = {
    ...
    execute(client: any, interaction: any, player: any) {
        ...
        const tracks = queue.tracks.map((track: { title: any; author: any; requestedBy: { username: any; }; }, i: number) => `**${i + 1}** - ${track.title} | ${track.author} (requested by : ${track.requestedBy.username})`);
